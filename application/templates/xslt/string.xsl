...
<xsl:stylesheet version="1.0"
	...
	extension-element-prefixes="doc str php">
...
<xsl:template name='str:url-decode'>
    <xsl:param name="input" select="'urn:check%20out%20my%20r%E9sum%E9'"/>
    <xsl:value-of select="php:function ( 'urldecode', $input )" />
</xsl:template>

<xsl:template name='str:url-encode'>
    <xsl:param name="input" select="'urn:check%20out%20my%20r%E9sum%E9'"/>
    <xsl:value-of select="php:function ( 'urlencode', $input )" />
</xsl:template>
