function add_new_access_rule () {
    ...
    div = div + '<td>=&nbsp;<input type="text" id="'+text+'__what" name="f:'+text+'__what" value="" style="width:90%;"></td>' ;
    div = div + '<td><input type="text" id="'+text+'__comment" name="f:'+text+'__comment" value="" style="width:90%;"></td>' ;
    div = div + '<td> then <select id="'+text+'__rule" name="f:'+text+'__rule"><option value="a" selected="selected">Allow</option><option value="d">Deny</option></select></td>' ;
