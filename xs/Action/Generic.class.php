<?php
    ...
    class Generic extends \xs\Events\Plugin {
        ...
        function __construct ( $values = null ) {
            ...
            // Go to parents constructor first, making this a EventStackPlugin class
            parent::__construct() ;
            ...
            $items = array ( 'meta', 'page', 'properties', 'settings', 'technical' ) ;
...
*/
        ...
        function _http_action () {
            ...
            $this->glob->log->add ( 'Action : ACTION : End' ) ;
        }
        ...
        function _init_output () {
            ...
            $response = new \xs\Output\XmlResponse ( $this->glob->stack ) ;
        ...
        function _render_output ( ) {
            ...
            $this->output = new \xs\Output\Controller ( $this->_output_xml, $this->glob->stack, $this->_page->template ) ;
