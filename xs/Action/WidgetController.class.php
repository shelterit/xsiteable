<?php
    ...
    class WidgetController extends \xs\Action\Widget {
        ...
        function _add_instance ( $instance_id = null, $data = array () ) {
            ...
            if ( $instance_id != null ) {
                ...
                $this->instances[$instance_id] = new \xs\Action\WidgetInstance ( $this->controller_name, $instance_id ) ;
        ...
        function get_instance ( $instance_id = null ) {
            ...
            $i = new \xs\Action\WidgetInstance ( $instance_id ) ;
