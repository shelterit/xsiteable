<?php
    ...
    class Plugin extends \xs\Core {
        ...
        function __construct ( $lifeless = false ) {
            ...
            $this->_meta       = new \xs\Store\Properties () ;
            $this->_page       = new \xs\Store\Properties () ;
            $this->_properties = new \xs\Store\Properties () ;
            $this->_settings   = new \xs\Store\Properties () ;
            $this->_technical  = new \xs\Store\Properties () ;
