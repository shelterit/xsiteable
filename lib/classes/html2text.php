...
class html2text
{
    ...
    function html2text( $source = '', $from_file = false )
    {
        ...
        $this->set_base_url();
        ini_set( 'pcre.backtrack_limit', (int)200000 );
        // echo "html2text pcre-limit=[".ini_get( 'pcre.backtrack_limit')."]" ;
    }
    ...
    function _convert()
    {
        ...
        $text = chunk_split ( $text, 10000, "-=blender=-") ;

        $chunks = explode ( "-=blender=-", $text ) ;
